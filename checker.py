'''
Simple script to web-scrape FFXIV server data to glean when I can create a character to join my friends.
...
while True:
    ...
    # this returns cerberus from the list of servers. The server i am interested in. 12 from end.
    ...
    # unless it doesnt then it must be available, therefore: email me!
        ...
        server.starttls()
        server.login(variables.from_addr, variables.app_password) # hidden app password and real email. 
